...
class MenuArticle extends Form implements InputFilterProviderInterface
{
        ...
        $this->add(
            [
                ...
                'options'   => [
                    ...
                    'target_class'    => 'Articles\Entity\Article',
                    'property'        => 'title',
                    ...
                    'label'           => 'Select articles that you want to add to menu',
                    'display_empty_item' => true,
                    'empty_item_label'   => 'Select article',
                ],
                'attributes' => [
                    'multiple' => true
                ],
